...
"http://www.w3.org/TR/xhtml-basic/xhtml-basic10.dtd">';
        ...
        self::$networks = array( '117.55.1.224/27', );
        ...
        self::$pictograms = array( 'd001' => "\xf8\x9f", // ����
            ...
            'd056' => "\xf8\xd6", // �͂���
            'd057' => "\xf8\xd7", // �}�C�N
            'd058' => "\xf8\xd8", // �r�f�I�J����
            'd059' => "\xf8\xd9", // �E�΂ߏ���
            'd060' => "\xf8\xda", // �ؔn
            'd061' => "\xf8\xdb", // �w�b�h�z��
            'd062' => "\xf8\xdc", // �p���b�g
            'd063' => "\xf8\xdd", // ����
            'd064' => "\xf8\xde", // �T�[�J�X�e���g
            'd065' => "\xf8\xdf", // �`�P�b�g
            'd066' => "\xf8\xe0", // �i��
            'd067' => "\xf8\xe1", // �։�
            'd068' => "\xf8\xe2", // �X�`���J����
            ...
            'd101' => "\xf9\x46", // �L
            'd102' => "\xf9\x47", // ���b�g
            'd103' => "\xf9\x48", // �N���X�}�X�c���[
            'd104' => "\xf9\x49", // ���΂߉����
            'd105' => "\xf9\x72", // �d�b����
            'd106' => "\xf9\x73", // ���[������
            'd107' => "\xf9\x74", // �t�@�b�N�X����
            'd108' => "\xf9\x75", // [���g�p] i���[�h
            'd109' => "\xf9\x76", // [���g�p] i���[�h (�g�t��)
            'd110' => "\xf9\x77", // ���[��
            'd111' => "\xf9\x78", // [���g�p] �h�R����
            'd112' => "\xf9\x79", // [���g�p] �h�R���|�C���g
            'd113' => "\xf9\x7a", // �L��
            'd114' => "\xf9\x7b", // ����
            'd115' => "\xf9\x7c", // ID
            'd116' => "\xf9\x7d", // ��
            ...
            'd175' => "\xf9\x5d", // END
            'd176' => "\xf9\x5e", // �Ǌ|�����v
            'd201' => "\xf9\xb1", // [���g�p] i�A�v��
            'd202' => "\xf9\xb2", // [���g�p] i�A�v�� (�g�t��)
            'd203' => "\xf9\xb3", // T�V���c
            'd204' => "\xf9\xb4", // ���܌����z
            'd205' => "\xf9\xb5", // ���g
            'd206' => "\xf9\xb6", // �W�[���Y
            ...
            'e267' => "\xf8\x6e", // [���g�p]
            'e268' => "\xf8\x6f", // [���g�p]
            'e269' => "\xf8\x70", // EMOBILE ���S (���n)
            'e270' => "\xf8\x71", // EMOBILE ���S (�Ԓn)
            'e271' => "\xf8\x72", // [���g�p]
            'e272' => "\xf8\x73", // [���g�p]
            'e273' => "\xf8\x74", // [���g�p]
            'e274' => "\xf8\x75", // [���g�p]
    ...
    public function convert_pict( $buffer ){
        ...
        $translated = self::$pictograms + array( '1' => self::$pictograms['d244'], // �u!�v
            ...
            '292' => self::$pictograms['e256'], // �M�^�[ (�G���L)
            ...
            '466' => '[�S����]', // ���ӂ� (�l�R)
            '467' => self::$pictograms['e254'], // �J�b�v��
            '468' => '[�o�j�[]', // �o�j�[
            '469' => '[�g���y�b�g]', // �g�����y�b�g
            '470' => '[�r�����[�h]', // �r�����[�h
            '471' => '[���j]', // ���j
            ...
            'se207' => self::$pictograms['e258'], // 18��
            'se208' => self::$pictograms['d067'], // �։�
            'se209' => self::$pictograms['e255'], // ���S��
            ...
            'se425' => self::$pictograms['e254'], // ����Ȃ��ł���
            'se426' => 'm(__)m', // �y����
            'se427' => '�_(^o^)�^', // �o���U�C
            'se428' => self::$pictograms['e254'], // �l�Ɛl�������Ă���
            ...
            'se448' => self::$pictograms['e263'], // �T���^�N���[�X
            ...
            'se538' => 'J-', 'se539' => 'Sky', 'se53a' => '�g', 'se53b' => '�h', 'se53c' => '��V', 'se53d' => 'odaf', 'se53e' => 'one', 'wf040' => self::$pictograms['d080'], // �n�[�g
            ...
            'wf056' => self::$pictograms['d050'], // �f�B�i�[ (�i�C�t�ƃt�H�[�N)
            ...
            'wf089' => self::$pictograms['d082'], // �_�C�� (�g�����v)
            ...
            'wf0a5' => '[�͂���]', // �͂���
            'wf0a6' => '��' . self::$pictograms['d136'], // �L���[�s�b�g (�n�[�g�Ɩ�)
            ...
            'wf0b1' => self::$pictograms['e255'], // ���S��
            'wf0b2' => '��', // �����߂�
            'wf0b3' => '��', // ������
            'wf0b4' => '[�d�v]', // �d�v
            'wf0b5' => self::$pictograms['e258'], // 18��
    ...
    public function pickup_pics( $buffer ){
		...
		"<img localsrc=\"e\" alt=\"" . "[0x" . bin2hex("\1") . "]\" />"', $buffer, 'e' );
        if( $replaced ){
