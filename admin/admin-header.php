...
<head>
    <meta http-equiv="Content-Type"
          content="<?php echo esc_html( $mime_type ); ?>; charset=<?php echo esc_html( $iana_charset ); ?>"/>
    <title><?php
...
<div align="right"><?php printf( __( 'Howdy, %s.', 'ktai_style' ), $user_identity ) ?><a href="#tail"><img localsrc="30"
                                                                                                           alt="<?php _e( '&darr;', 'ktai_style' ); ?>"/></a>
</div>
<hr color="#4f96c8"/>
