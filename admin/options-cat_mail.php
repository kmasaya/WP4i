...
<?php } ?>
    ...
    <form method="post" action="options.php">
        <?php $Ktai_Style->admin->sid_field();
        wp_nonce_field( 'update-options', "_wpnonce", FALSE ); ?>
...
if( class_exists( 'KtaiEntry' ) || class_exists( 'Ktai_Entry' ) ){
    ...
    <p>
        <a href="<?php echo esc_attr( $Ktai_Entry->retrieve_url() ); ?>"><?php _e( 'Retrieve new mail posts', 'ktai_style' ); ?></a><br/><?php _e( '(After checking, back to here by using "Back" feature of your terminal.)', 'ktai_style' ); ?>
    </p>
<?php
}
