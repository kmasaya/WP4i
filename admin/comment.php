...
class KtaiAdmin_Comments{
    ...
    private function edit_form(){
        ...
        <form action="comment.php" method="post">
            ...
            <div><?php _e( 'Name' ) ?><br/>
                <input type="text" name="newcomment_author" size="24" maxlength="99"
                       value="<?php echo $comment->comment_author; ?>" tabindex="1"/><br/>
                <?php _e( 'E-mail' ) ?><br/>
                <input type="text" name="newcomment_author_email" size="30" maxlength="128"
                       value="<?php echo $comment->comment_author_email; ?>" tabindex="2"/><br/>
                <?php _e( 'URL' ) ?><br/>
                <input type="text" name="newcomment_author_url" size="36" maxlength="256"
                       value="<?php echo $comment->comment_author_url; ?>" tabindex="3"/><br/>
                ...
                <input name="comment_status" type="radio"
                       value="1" <?php checked( $comment->comment_approved, '1' ); ?> /> <?php printf( __( '<font color="%s">Approved</font>', 'ktai_style' ), 'green' ); ?>
                <input name="comment_status" type="radio"
                       value="0" <?php checked( $comment->comment_approved, '0' ); ?> /> <?php printf( __( '<font color="%s">Pending</font>', 'ktai_style' ), '#ff9900' ); ?>
                <input name="comment_status" type="radio"
                       value="spam" <?php checked( $comment->comment_approved, 'spam' ); ?> /> <?php printf( __( '<font color="%s">Spam</font>', 'ktai_style' ), 'red' ); ?>
                <br/>
                <?php
                ...
                ?><img localsrc="61"/><a href="<?php echo esc_attr( $delete_url ); ?>"><font
                        color="fuchsia"><?php echo $button; ?></font></a>
    ...
    private function confirm( $action ){
        ...
        <form action="edit-comments.php" method="get">
            ...
            <div><input type="submit" value="<?php _e( 'No' ); ?>"/></div>
        </form>
        ...
        <dl>
        <dt><img localsrc="<?php comment_type( 68, 112, 112 ); ?>"
                 alt="[<?php comment_type( __( 'Comment', 'ktai_style' ), __( 'Trackback' ), __( 'Pingback' ) ); ?>] "/><?php comment_author(); ?>
            <img localsrc="46" alt=" @ "/><font
                color="<?php echo ks_option( 'ks_date_color' ); ?>"><?php ks_comment_datetime(); ?></font></dt>
        <dd><?php
