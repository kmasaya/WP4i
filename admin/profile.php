            ...
            <form action="" method="post">
                <div>
                    ...
                    <label><?php _e( 'Nickname' ) ?><br/>
                        <input type="text" name="nickname" size="100%" tabidex="1"
                               value="<?php echo esc_attr( $profileuser->nickname ); ?>"/></label><br/>
                    <label><?php _e( 'E-mail' ) ?><br/>
                        <input type="text" name="email" size="100%" istyle="3" mode="alphabet" tabidex="2"
                               value="<?php echo esc_attr( $profileuser->user_email ); ?>"/></label></div>
