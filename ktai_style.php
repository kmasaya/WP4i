...
class KtaiStyle{
    ...
    public function admin_available_wp_upper(){
        return ( self::ADMIN_AVAILABLE_WP_NEWEST < 1 || $this->check_wp_version( self::ADMIN_AVAILABLE_WP_NEWEST, '<=' ) );
    }
    ...
    public function similar_encoding( $encoding1, $encoding2 ){
        $normalize = array( 'shift_jis' => 'sjis', 'sjis-win' => 'sjis', 'cp932' => 'sjis', 'eucjp-win' => 'euc-jp', 'iso-2022-jp' => 'jis', 'iso-2022-jp-1' => 'jis', 'iso-2022-jp-2' => 'jis', );
    ...
    public function show_mobile_url(){
        ...
        <link rel="alternate" media="handheld" type="text/html"
              href="<?php echo htmlspecialchars( $url, ENT_QUOTES ); ?>"/>
    <?php
    }
    ...
    public function show_mobile_url_atom_head(){
        ...
        ?>
        <link rel="alternate" x:media="handheld" type="text/html"
              href="<?php echo htmlspecialchars( $url, ENT_QUOTES ); ?>"/>
    <?php
    }
    ...
    public function show_mobile_url_rss2_head(){
        ...
        ?>
        <xhtml:link rel="alternate" media="handheld" type="text/html"
                    href="<?php echo htmlspecialchars( $url, ENT_QUOTES ); ?>"/>
    <?php
    }
...
E__O__T;
    ...
    public function switch_ktai_view(){
        ...
        $menu = '<div id="switch-mobile"><a href="' . esc_attr( $here . ( strpos( $here, '?' ) === FALSE ? '?' : '&' ) . 'pcview=false' ) . '">' . __( 'To Mobile view', 'ktai_style' ) . '</a></div>';
    ...
    public function strip_host( $url = '/' ){
        ...
        if( isset( $url_parts['host'] ) && $url_parts['host'] == $http_host[0] && ( !isset( $url_parts['port'] ) || $url_parts['port'] == $http_host[1] ) ){
        ...
        if( !defined( 'KTAI_ADMIN_HEAD' ) ) :
            ...
            <head>
                <meta http-equiv="Content-Type"
                      content="<?php echo $mime_type; ?>; charset=<?php echo $iana_charset; ?>"/>
