...
<?php if( have_posts() ) : the_post();
    if( !ks_is_comments() ) : ?>
        ...
        <div align="right"><img localsrc="68" alt=""/><font
        ...
        <?php ks_content( __( '(more...)' ) );
        ks_link_pages(); ?>
        <div><img localsrc="44" alt=""/><font size="-1"><?php echo __( 'Categories' ) . ':';
                ks_category(); ?></font><br/><?php
            ks_tags( '<img localsrc="119" alt="" /><font size="-1">' . __( 'Tags' ) . ':', '</font><br />' );
            if( ks_option( 'ks_separate_comments' ) ){
                ks_comments_link( '<img localsrc="811" alt="" />', __( 'No Comments/Pings', 'ktai_style' ), __( 'One Comment/Ping', 'ktai_style' ), __( '% Comments and Pings', 'ktai_style' ) );
            } else{
        ...
        ks_next_post_link( '<div align="right">#.%link<img localsrc="8" alt=" &raquo;"></div>' ); else : // ks_is_comment()
