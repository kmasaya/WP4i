...
if( ks_redir_has( 'full_url' ) ) :
    ?>
    <div<?php echo $ks_settings['h2_style']; ?>>
    <h2><?php _e( 'Confirm connecting to external sites', 'ktai_style' ); ?></h2></div>
...
<?php
    ...
    <br/><a
        href="<?php echo esc_url( ks_redir_get( 'mobile_url' ) ); ?>"><?php echo esc_url( ks_redir_get( 'mobile_url' ) ); ?></a>
    ...
    <form action="">
        <div><input type="text" name="url" size="80" maxlength="255"
                    value="<?php echo esc_url( ks_redir_get( 'full_url' ) ); ?>"/></div>
    </form>
<?php else: // ks_redir_has ?>
    <div<?php echo $ks_settings['h2_style']; ?>><h2><?php _e( 'Error linking to external sites', 'ktai_style' ); ?></h2>
    </div>
