...
<dl>
    <dt><?php
        ...
        ks_ordered_link( $count++, $max, ks_blogurl( KTAI_NOT_ECHO ) . '?menu=comments', ( ks_option( 'ks_separate_comments' ) ? __( 'Recent Comments/Pings', 'ktai_style' ) : __( 'Recent Comments', 'ktai_style' ) ) ); ?></dt>
    ...
    <dt><?php ks_ordered_link( $count++, $max, ks_blogurl( KTAI_NOT_ECHO ) . '?menu=cats', __( 'Categories' ) );
        _e( ' / ', 'ktai_style' );
        ks_ordered_link( $count++, $max, ks_blogurl( KTAI_NOT_ECHO ) . '?menu=tags', __( 'Tags' ) ); ?></dt>
