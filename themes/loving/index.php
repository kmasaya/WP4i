...
if( have_posts() ) :
    ...
    while( have_posts() ) : the_post();
        ?>
        <dt><br/><img localsrc="144" alt=""/><a href="<?php the_permalink(); ?>"><span
                style="<?php echo $ks_settings['title_style']; ?>"><?php the_title(); ?></span></a><br/>
        <img localsrc="46" alt="@ "/><font color="<?php echo $ks_settings['date_color']; ?>"><?php ks_time(); ?></font>
        <br/>
        <?php ks_comments_link( array( 'zero' => __( 'No comments', 'ktai_style' ), 'one' => __( 'One comment', 'ktai_style' ), 'more' => __( '% comments', 'ktai_style' ), ) + $ks_settings['comments_icon'] );
