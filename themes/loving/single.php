...
if( have_posts() ) : the_post();
    if( !ks_is_comments() ) : ?>
        <h2><img localsrc="144" alt=""/><span
                style="<?php echo $ks_settings['title_style']; ?>"><?php the_title(); ?></span></h2>
        <div><img localsrc="251" alt=""/><font size="-1"><?php echo __( 'Categories' ) . ':';
                ks_category(); ?></font></div>
        <?php ks_content( __( '(more...)' ) );
        ks_link_pages(); ?>
        <p align="right"><img localsrc="68" alt="by "/><font color="#ff8c00"><?php the_author(); ?></font> <img
                localsrc="46" alt=" @ "/><font
                color="<?php echo $ks_settings['date_color']; ?>"><?php ks_time( 'Y-m-d H:i' ); ?></font></p>
