...
function ks_comment_content(){
    ...
    ?><img localsrc="46" alt=" @ "/><font
        color="<?php echo $ks_settings['date_color']; ?>"><?php ks_comment_datetime(); ?></font><br/>
...
global $wp_query, $comment, $ks_settings;
...
if ($cpage) {
$start_count = ( $cpage - 1 ) * get_option( 'comments_per_page' ) + 1;
?>
<ol start="<?php echo $start_count; ?>"><?php
    } else {
    ?>
    <ol><?php
        }
        wp_list_comments( array( 'walker' => $walker, 'avatar_size' => 0, 'edit_color' => $ks_settings['edit_color'] ), $_comments );
